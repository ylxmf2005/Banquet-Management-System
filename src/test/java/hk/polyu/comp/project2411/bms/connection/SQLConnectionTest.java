...
public class SQLConnectionTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            sql = """
                    INSERT INTO Account (Email, FirstName, LastName, MobileNo, Password, Location, Address, Type, Organization)
            ...
            String selectSql = "SELECT Email, FirstName, LastName FROM Account";
            ...
            String selectPreparedSql = "SELECT Email, FirstName, LastName FROM Account WHERE Email = ?";
            ...
            String updateSql = "UPDATE Account SET MobileNo = '88888888' WHERE Email = 'example@example.com'";
            ...
            String updatePreparedSql = "UPDATE Account SET Password = ? WHERE Email = ?";
            ...
            String deleteSql = "DELETE FROM Account WHERE Email = 'example@example.com'";
            ...
            String deletePreparedSql = "DELETE FROM Account WHERE Email = ?";
            Object[] deleteParams = { "example2@example.com" };
            rowsDeleted = dbConn.executePreparedUpdate(deletePreparedSql, deleteParams);
            System.out.println("Deleted " + rowsDeleted + " record(s).");

            // 10. Drop the table
            System.out.println("\n10. Dropping the Account table:");
            String dropTableSql = "DROP TABLE Account";
            try {
                dbConn.executeUpdate(dropTableSql);
                System.out.println("Table 'Account' dropped successfully.");
            } catch (Exception e) {
